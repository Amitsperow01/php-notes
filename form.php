		...
		<table cellpadding="10">
			...
			<tr>
				...
				<td><select name="dob_day">
						...
						<?php
						for ($i = 1; $i <= 31; $i++) { ?>
							<option value='<?= $i ?>' <?= ($_SESSION["dob_day"] ?? NUll) == $i ? "selected" : "" ?>><?= $i ?></option>
						<?php } ?>
					</select>
					<select name="dob_month">
						...
						<option value='<?= $month ?>'<?= ($_SESSION["dob_month"] ?? NULL) == $month ? "selected" : ""?>><?= $month ?></option>
					...
					<select name="dob_year">
						...
						<option value='<?= $i ?>'<?= (($_SESSION["dob_year"] ?? NULL) == $i) ? "selected" : ""?> ><?= $i ?></option>
			...
			<tr>
				...
				<td><input type="checkbox" name="hobbies[]" value="drowing" <?= (in_array("drowing", ($_SESSION['hobbies'] ?? []))) ? "checked" : ""; ?>>Drowing
					...
					<input type="checkbox" name="other_hobbies" value="other" <?= (in_array("other", ($_SESSION['hobbies'] ?? []))) ? "checked" : ""; ?>>other
