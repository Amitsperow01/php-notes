...
if ($isError) {
 ...
 $instQuery="INSERT INTO `student-list` (first_name,last_name,email,mobile_number,gender,date_of_birth,address,city,pin_code,state,country,hobbies,other_hobbies,qualification,course)VALUE ('$first_name','$last_name
